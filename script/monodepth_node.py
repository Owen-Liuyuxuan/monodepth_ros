...
class RosNode:
    ...
    def _read_params(self):
        ...
        self.cfg.data.test_augmentation.cfg_list[1].size = (self.inference_h, self.inference_w)
    ...
    def _init_model(self):
        ...
        self.transform = build(**self.cfg.data.test_augmentation)
    ...
    def _predict_depth(self, image):
        ...
        # np.clip(depth, 0, self.max_depth, out=depth)
